    ...
    if (!isAdmin) {
      return {
        ...
        body: JSON.stringify({
          ...
          preorderEnabled: typeof settings?.preorderEnabled === "boolean" ? settings.preorderEnabled : true,
...
async function handlePut(body) {
  ...
  const next = {
    ...
    preorderEnabled: typeof updates.preorderEnabled === "boolean" ? updates.preorderEnabled : true,
